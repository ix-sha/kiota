...
public class DiscriminatorInformation : CodeElement, ICloneable
{
    ...
    public bool ShouldWriteParseNodeCheck => ShouldWriteDiscriminatorForInheritedType || (ShouldWriteDiscriminatorForUnionType && HasBasicDiscriminatorInformation) || ShouldWriteDiscriminatorForIntersectionType;
